...
function buildConfigHtml() {
  ...
  var lines = [
    ...
    '  <button class="ghost-btn" style="white-space:nowrap" onclick="triggerFileInput()">&#x1F4C2; Import file</button>',
    '  <span id="fileLabel" style="color:#8a8a90;font-size:12px">.txt &amp; .epub supported</span>',
    '</div>',
    ...
    '<textarea id="txt" placeholder="Paste your script here, or import a file above…" oninput="onTextChange()"></textarea>',
    '</div>',
